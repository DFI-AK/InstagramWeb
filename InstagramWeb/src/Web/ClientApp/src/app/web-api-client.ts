        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserProfileVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserProfileVm>;
        }));
    }

    protected processGetUserInfo(response: HttpResponseBase): Observable<UserProfileVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IUserPostClient {
    getAllUsersPosts(): Observable<UserPost[]>;
...
export class UserPostClient implements IUserPostClient {
    ...
    getAllUsersPosts(): Observable<UserPost[]> {
        let url_ = this.baseUrl + "/api/UserPost/GetAllUsersPosts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllUsersPosts(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllUsersPosts(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<UserPost[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserPost[]>;
        }));
    }

    protected processGetAllUsersPosts(response: HttpResponseBase): Observable<UserPost[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(UserPost.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["posts"])) {
                ...
                for (let item of _data["posts"])
                    this.posts!.push(UserPost.fromJS(item));
            }
...
export class UserPost implements IUserPost {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.postOn = _data["postOn"] ? new Date(_data["postOn"].toString()) : <any>undefined;
            this.category = _data["category"];
        }
    }

    static fromJS(data: any): UserPost {
        data = typeof data === 'object' ? data : {};
        let result = new UserPost();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["postOn"] = this.postOn ? this.postOn.toISOString() : <any>undefined;
...
export class UserProfileVm implements IUserProfileVm {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["postCategories"])) {
                this.postCategories = [] as any;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.postCategories)) {
            data["postCategories"] = [];
            for (let item of this.postCategories)
                data["postCategories"].push(item.toJSON());
        }
